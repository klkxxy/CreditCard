...
-(void)show
{
    ...
    if (self.destructiveTitle) {
        //LSActionSheetDestructiveButtonColor
    ...
    //LSActionSheetCancelButtonColor
    ...
    contentView.backgroundColor=  LSActionSheetContentViewBackgroundColor;//LSActionSheetContentViewBackgroundColor;
...
-(UIButton*)createButtonWithTitle:(NSString*)title  color:(UIColor*)color font:(UIFont*)font height:(CGFloat)height y:(CGFloat)y
{
    ...
    button.backgroundColor= LSActionSheetButtonBackgroundColor;//LSActionSheetButtonBackgroundColor;
